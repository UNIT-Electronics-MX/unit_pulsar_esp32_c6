...
.. tabs:: 
  ...
  .. tab:: MicroPython
    ...
    **Installation**
    ...
    1. Open |thonny_link_i2c|.
    2. Copy the library from |ssd1306_link|.
    3. Paste the library into a new file in Thonny and save it as `ssd1306.py` on your device.

    .. |thonny_link_i2c| raw:: html

       <a href="https://thonny.org/" target="_blank">Thonny</a>

    .. |ssd1306_link| raw:: html

       <a href="https://github.com/UNIT-Electronics-MX/unit_devlab_micropython_libraries/blob/main/software/ssd1306/ssd1306.py" target="_blank">ssd1306.py</a>
...
.. only:: html
   ...
   .. figure:: https://raw.githubusercontent.com/UNIT-Electronics-MX/unit_emotionally_pulsar_c6_mp/refs/heads/main/hardware/resources/14.gif
      :align: center
      :alt: Emotionally Demo
      :width: 60%

      Emotionally – Reacting Face Demo

For complete code, schematics, and detailed instructions, visit the |emotionally_project|.

.. |emotionally_project| raw:: html

   <a href="https://www.hackster.io/mrcronos/emotionally-reacting-face-with-micropython-on-pulsar-c6-aa4a40" target="_blank">Hackster.io project page</a>